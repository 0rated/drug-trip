...
Shader "Shader Forge/Examples/Refraction" {
    Properties {
        ...
        _WallColor ("WallColor", Color) = (0,0.8669877,0.9044118,1)
...
////// Specular:
                ...
                float3 diffuseColor = _WallColor.rgb; // Need this for specular when using metallic
